...
namespace API.Controllers
{
    ...
    public class DoctorsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateDoctor([FromBody] Doctor doctor)
        {
            ...
            // ✅ Ensure default verification status for new doctors
            if (doctor.VerificationStatus == 0)
                doctor.VerificationStatus = DoctorVerificationStatus.PendingCertificateUpload;
        ...
        public async Task<IActionResult> UpdateDoctorByClientId(string clientId, [FromBody] Doctor updatedDoctor)
        {
            if (updatedDoctor == null) return BadRequest("updatedDoctor cannot be null");
